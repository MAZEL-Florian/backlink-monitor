        ...
        <form action="{{ route('backlinks.update', $backlink) }}" method="POST" class="space-y-6 p-6">
            ...
            <div>
                ...
                @error('anchor_text')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">Le texte cliquable du lien</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Décochez si le lien est en nofollow</p>
            </div>
            ...
            <div>
                ...
                <textarea name="notes" 
                          ...
                          placeholder="Notes optionnelles sur ce backlink...">{{ old('notes', $backlink->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-between pt-4">
                <div class="flex space-x-3">
                    <a href="{{ route('backlinks.show', $backlink) }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400">
                        Annuler
                    </a>
